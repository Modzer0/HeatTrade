...
public class LTDescr
{
  ...
  public int uniqueId => (int) this._id | (int) this.counter << 16 /*0x10*/;
  ...
  public LTDescr setAlpha()
  {
    ...
    this.initInternal = (LTDescr.ActionMethodDelegate) (() =>
    {
      ...
      {
        IEnumerator enumerator = (IEnumerator) this.trans.GetEnumerator();
        try
        {
          while (enumerator.MoveNext())
          {
            Transform current = (Transform) enumerator.Current;
            if ((UnityEngine.Object) current.gameObject.GetComponent<Renderer>() != (UnityEngine.Object) null)
            {
              this.fromInternal.x = current.gameObject.GetComponent<Renderer>().material.color.a;
              break;
            }
          }
        }
      ...
      else
      {
        ...
        try
        {
          while (enumerator.MoveNext())
          {
            ...
            if ((UnityEngine.Object) current.gameObject.GetComponent<Renderer>() != (UnityEngine.Object) null)
            {
              this.setFromColor(current.gameObject.GetComponent<Renderer>().material.color);
              break;
            }
          }
        }
  ...
  public LTDescr setCanvasAlpha()
  {
    ...
    this.easeInternal = (LTDescr.ActionMethodDelegate) (() =>
    {
      ...
      if (!this.useRecursion)
        return;
      LTDescr.alphaRecursive(this.rectTransform, LTDescr.val);
  ...
  private static void alphaRecursive(Transform transform, float val, bool useRecursion = true)
  {
    ...
    if (!useRecursion || transform.childCount <= 0)
      return;
    IEnumerator enumerator = (IEnumerator) transform.GetEnumerator();
    try
    {
      while (enumerator.MoveNext())
        LTDescr.alphaRecursive((Transform) enumerator.Current, val);
    }
    finally
    {
  ...
  private static void colorRecursive(Transform transform, Color toColor, bool useRecursion = true)
  {
    ...
    {
      while (enumerator.MoveNext())
        LTDescr.colorRecursive((Transform) enumerator.Current, toColor);
    }
    finally
    {
      if (enumerator is IDisposable disposable)
  ...
  private static void alphaRecursive(RectTransform rectTransform, float val, int recursiveLevel = 0)
  {
    if (rectTransform.childCount <= 0)
      return;
    IEnumerator enumerator = (IEnumerator) rectTransform.GetEnumerator();
    try
    {
      while (enumerator.MoveNext())
      {
        RectTransform current = (RectTransform) enumerator.Current;
        MaskableGraphic component1 = (MaskableGraphic) current.GetComponent<Image>();
        ...
        {
          MaskableGraphic component2 = (MaskableGraphic) current.GetComponent<RawImage>();
        ...
        LTDescr.alphaRecursive(current, val, recursiveLevel + 1);
      }
    }
    finally
    {
  ...
  private static void alphaRecursiveSprite(Transform transform, float val)
  {
    ...
    try
    {
      ...
      {
        Transform current = (Transform) enumerator.Current;
        SpriteRenderer component = current.GetComponent<SpriteRenderer>();
        if ((UnityEngine.Object) component != (UnityEngine.Object) null)
          component.color = new Color(component.color.r, component.color.g, component.color.b, val);
        LTDescr.alphaRecursiveSprite(current, val);
      }
    }
    finally
    {
  ...
  private static void colorRecursiveSprite(Transform transform, Color toColor)
  {
    ...
    try
    {
      while (enumerator.MoveNext())
      {
        ...
        LTDescr.colorRecursiveSprite(current, toColor1);
      }
    }
    finally
    {
  ...
  private static void colorRecursive(RectTransform rectTransform, Color toColor)
  {
    ...
    try
    {
      while (enumerator.MoveNext())
      {
        ...
        LTDescr.colorRecursive(current, toColor);
      }
    }
    finally
    {
  ...
  private static void textAlphaChildrenRecursive(Transform trans, float val, bool useRecursion = true)
  {
    if (!useRecursion || trans.childCount <= 0)
      return;
    IEnumerator enumerator = (IEnumerator) trans.GetEnumerator();
    try
    {
      while (enumerator.MoveNext())
      {
        ...
        LTDescr.textAlphaChildrenRecursive(current, val);
      }
    }
    finally
    {
  ...
  private static void textAlphaRecursive(Transform trans, float val, bool useRecursion = true)
  {
    ...
    {
      while (enumerator.MoveNext())
        LTDescr.textAlphaRecursive((Transform) enumerator.Current, val);
    }
    finally
    {
      if (enumerator is IDisposable disposable)
  ...
  private static void textColorRecursive(Transform trans, Color toColor)
  {
    ...
    try
    {
      while (enumerator.MoveNext())
      {
        ...
        if ((UnityEngine.Object) component != (UnityEngine.Object) null)
          component.color = toColor;
        LTDescr.textColorRecursive(current, toColor);
      }
    }
    finally
    {
