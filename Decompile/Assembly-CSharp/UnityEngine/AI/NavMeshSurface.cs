...
public class NavMeshSurface : MonoBehaviour
{
  ...
  [SerializeField]
  private int m_TileSize = 256 /*0x0100*/;
  [SerializeField]
  ...
  public void BuildNavMesh()
  {
    ...
    NavMeshData navMeshData = NavMeshBuilder.BuildNavMeshData(this.GetBuildSettings(), (List<NavMeshBuildSource>) sources, localBounds, this.transform.position, this.transform.rotation);
  ...
  public AsyncOperation UpdateNavMesh(NavMeshData data)
  {
    ...
    if (this.m_CollectObjects == CollectObjects.All || this.m_CollectObjects == CollectObjects.Children)
      localBounds = this.CalculateWorldBounds(sources);
    return NavMeshBuilder.UpdateNavMeshDataAsync(data, this.GetBuildSettings(), (List<NavMeshBuildSource>) sources, localBounds);
  }
  ...
  private List<NavMeshBuildSource> CollectSources()
  {
    ...
    if (this.m_CollectObjects == CollectObjects.All)
      NavMeshBuilder.CollectSources((Transform) null, (int) this.m_LayerMask, this.m_UseGeometry, this.m_DefaultArea, (List<NavMeshBuildMarkup>) markups, (List<NavMeshBuildSource>) sources);
    else if (this.m_CollectObjects == CollectObjects.Children)
      NavMeshBuilder.CollectSources(this.transform, (int) this.m_LayerMask, this.m_UseGeometry, this.m_DefaultArea, (List<NavMeshBuildMarkup>) markups, (List<NavMeshBuildSource>) sources);
    else if (this.m_CollectObjects == CollectObjects.Volume)
      NavMeshBuilder.CollectSources(NavMeshSurface.GetWorldBounds(Matrix4x4.TRS(this.transform.position, this.transform.rotation, Vector3.one), new Bounds(this.m_Center, this.m_Size)), (int) this.m_LayerMask, this.m_UseGeometry, this.m_DefaultArea, (List<NavMeshBuildMarkup>) markups, (List<NavMeshBuildSource>) sources);
