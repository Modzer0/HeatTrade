...
public class TextMeshProFloatingText : MonoBehaviour
{
  ...
  private void Start()
  {
    if (this.SpawnType == 0)
    {
      ...
      this.StartCoroutine((IEnumerator) this.DisplayTextMeshProFloatingText());
    }
    else if (this.SpawnType == 1)
    {
      ...
      this.StartCoroutine((IEnumerator) this.DisplayTextMeshFloatingText());
    }
    else
    {
  ...
  public IEnumerator DisplayTextMeshProFloatingText()
  {
    ...
    meshProFloatingText.StartCoroutine((IEnumerator) meshProFloatingText.DisplayTextMeshProFloatingText());
  }
  ...
  public IEnumerator DisplayTextMeshFloatingText()
  {
    ...
    meshProFloatingText.m_floatingText_Transform.position = start_pos;
    meshProFloatingText.StartCoroutine((IEnumerator) meshProFloatingText.DisplayTextMeshFloatingText());
  }
}
