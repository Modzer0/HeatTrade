...
public class Benchmark01 : MonoBehaviour
{
  ...
  private IEnumerator Start()
  {
    ...
    if (benchmark01.BenchmarkType == 0)
    {
      ...
      if ((UnityEngine.Object) benchmark01.TMProFont != (UnityEngine.Object) null)
    ...
    else if (benchmark01.BenchmarkType == 1)
    {
      ...
      if ((UnityEngine.Object) benchmark01.TextMeshFont != (UnityEngine.Object) null)
      {
      ...
      {
        benchmark01.m_textMesh.font = UnityEngine.Resources.Load("Fonts/ARIAL", (System.Type) typeof (Font)) as Font;
        benchmark01.m_textMesh.GetComponent<Renderer>().sharedMaterial = benchmark01.m_textMesh.font.material;
      }
      benchmark01.m_textMesh.fontSize = 48 /*0x30*/;
    ...
    for (int i = 0; i <= 1000000; ++i)
    {
      if (benchmark01.BenchmarkType == 0)
      {
        ...
        if (i % 1000 == 999)
          benchmark01.m_textMeshPro.fontSharedMaterial = (UnityEngine.Object) benchmark01.m_textMeshPro.fontSharedMaterial == (UnityEngine.Object) benchmark01.m_material01 ? (benchmark01.m_textMeshPro.fontSharedMaterial = benchmark01.m_material02) : (benchmark01.m_textMeshPro.fontSharedMaterial = benchmark01.m_material01);
      }
      else if (benchmark01.BenchmarkType == 1)
